...
version = "1.0.1" // per-encoding image fields + quality setting
...
dependencies {
    ...
    compileOnly(libs.jackson.databind) // decrypted page list is JSON (host-provided)
...
tasks.named<Jar>("jar") {
    manifest {
        attributes(
            "Plugin-Id" to "hentainexus",
            "Plugin-Version" to project.version.toString(),
            "Plugin-Class" to "dev.kodex.plugin.hentainexus.HentaiNexusPlugin",
